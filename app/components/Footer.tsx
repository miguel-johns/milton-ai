...
export default function Footer({ mobile, onOpenChat }: FooterProps) {
  return (
    <>
    <style>{`
      .footer-link {
    ...
    <footer style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <Link href="/terms" className="footer-link" style={{ color: colors.inkMute, textDecoration: 'none' }}>Terms of Service</Link>
          <span style={{ opacity: 0.5 }}>·</span>
          <Link href="/privacy" className="footer-link" style={{ color: colors.inkMute, textDecoration: 'none' }}>Privacy Policy</Link>
        </div>
      </div>
    </footer>
    </>
