      ...
      <div style={{
        ...
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div style={sectionStyle}>
            ...
            <p style={paragraphStyle}>
              All other feedback, comments, requests for technical support, and other communications relating to the Website should be directed to: <a href="mailto:support@getmilton.com" style={{ color: colors.accent }}>support@getmilton.com</a>
            </p>
          </div>
        </div>
      </div>
