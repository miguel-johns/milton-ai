  ...
  const featureSections = [
    {
      ...
      subtitle: "You already know this. Every dollar, every retention number, every referral comes from what happens in that hour between a trainer and a client. Milton makes sure every one of those hours runs like your best trainer ran it.",
      bullets: [
        'Every trainer prepped before they walk onto the floor',
        'Every session built around what that client actually needs today',
    ...
    {
      title: "The extra 10% that builds the gym.",
      subtitle: "The session is the start, not the whole thing. It's the prep that made it feel dialed in. The check in the next morning. The note that remembered their daughter's recital. The little things that turn sessions into relationships and clients into members for life. Milton makes sure every trainer on your team delivers that, not just the one or two who do it naturally.",
      bullets: [
        "Every session prepped around that client's goals and last week",
        'Follow ups, check ins, and small touches handled by default',
        'The kind of customer service that keeps clients for years, from every coach on your floor',
      ],
    ...
    },
    {
      ...
      subtitle: "Milton works the way your gym coaches. Drop in your programs, your PDFs, your standards, your cues. Milton learns it and runs with it, in your language, to your standard.",
      bullets: [
        'Customize Milton to your gym in minutes, not weeks',
        'Update a cue or a standard once, every trainer sees it instantly',
        'No setup weekend, no IT project, no consultant required',
      ],
    ...
    {
      title: 'Make life easy on yourself.',
      subtitle: "Seriously. Get your trainers on Milton, set them up to deliver high quality sessions, and let Milton handle the tedious, repetitive, grunt work that's been eating your week. Prep, notes, follow ups, programming tweaks, the thousand tiny things that keep pulling you off the floor. You stop being the bottleneck. Your trainers perform like your best one. Your clients get the experience they signed up for. Your business grows because the system is finally doing what you've been doing in your head.",
