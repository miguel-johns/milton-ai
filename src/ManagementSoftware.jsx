      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 900, margin: "0 auto", padding: `0 ${px}px` }}>
        ...
        <section style={{
          ...
          >
            ...
            Connected Partners / Management Software
          </a>
          ...
          <h1 style={{
            ...
            Intelligence layered on top of <Accent>the systems you already run</Accent>
          </h1>
        ...
        {/* ═══════ DATA POINTS ═══════ */}
        <section style={{ padding: sectionPad }}>
          <SectionLabel text="Data Milton Pulls From Management Software" />
          <SectionDivider />
